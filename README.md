...
**Version 1.0.10** — Windows

Professional Vertical Streaming Plugin for OBS Studio — vertical production dock for Shorts, TikTok, Reels, and Twitch.

## Download

- **Setup.exe:** [Vertical-Shorts-Plugin-1.0.10-Setup.exe](https://github.com/PFS2689/verticalshorts/releases/latest/download/Vertical-Shorts-Plugin-1.0.10-Setup.exe)
- **Zip:** [Vertical-Shorts-Plugin-1.0.10.zip](https://github.com/PFS2689/verticalshorts/releases/latest/download/Vertical-Shorts-Plugin-1.0.10.zip)
