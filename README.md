...
- **Setup.exe:** [Vertical-Shorts-Plugin-1.0.8-Setup.exe](https://github.com/PFS2689/verticalshorts/releases/latest/download/Vertical-Shorts-Plugin-1.0.8-Setup.exe)
- **Zip:** [Vertical-Shorts-Plugin-1.0.8.zip](https://github.com/PFS2689/verticalshorts/releases/latest/download/Vertical-Shorts-Plugin-1.0.8.zip)
